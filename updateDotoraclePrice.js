...
async function main() {
    while (true) {
        let web3 = await new Web3(new Web3.providers.HttpProvider(config.rpc['1285'].http))
        let contract = await new web3.eth.Contract(dotABI, config.contracts.multipricefeed['1285'][0])
